                            ...
                            @if ($schedule->start_time > now() && $schedule->start_time < now()->addDays(7))
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <a href="{{ route('teacher.classrooms.show', $schedule->classroom) }}">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('teacher.classrooms.show', $schedule->classroom) }}" class="btn btn-info">Kelas</a>
                        @can('update-schedule', $schedule)
                            <a href="{{ route('teacher.schedules.edit', $schedule) }}" class="btn btn-default">Ubah</a>
                        @endcan
                        @can('create-attendance', $schedule)
                            <a href="{{ route('teacher.schedules.attendances.create', $schedule) }}" class="btn btn-primary">Presensi</a>
                        @endcan

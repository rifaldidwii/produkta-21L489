<x-app-layout>
    ...
    <x-app-card>
        ...
        <x-slot name="header">
            ...
            <x-link class="btn-sm btn-primary float-right" :href="route('admin.payments.edit', $payment)">ubah</x-link>
        </x-slot>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    ...
                    <h4>Jumlah</h4>
                    <p>{{ $payment->formatted_amount }}</p>
                    <h4>Deskripsi</h4>
                    <p>{{ $payment->description ?? '-' }}</p>
                    <h4>Tanggal Dibuat</h4>
                    <p>{{ $payment->formatted_created_at }}
                    <h4>Status</h4>
                    <p>{{ $payment->status }}
                    @if ($payment->status == 'Lunas')
                        <h4>Tanggal Dibayar</h4>
                        <p>{{ $payment->formatted_updated_at }}
                    @endif
                </div>
            </div>
        </div>

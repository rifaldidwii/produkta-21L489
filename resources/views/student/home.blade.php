        ...
        <div class="container-fluid d-flex align-items-center">
            <div class="row">
                <div class="col-lg-7 col-md-10">
                    <h1 class="display-2 text-white">Halo {{ auth()->user()->student->name }}</h1>
                    @if (is_null(auth()->user()->student->grade))
                        <p class="text-white mt-0 mb-5">Silahkan melengkapi profil dan melakukan pembayaran terlebih
                            dahulu sebelum melanjutkan.</p>
                        <a href="#profile" class="btn btn-neutral">Edit profil</a>
                    @else
                        <p class="text-white mt-0 mb-5">Ini adalah halaman utama. Silahkan memilih menu yang diinginkan
                ...
                <div class="card card-profile">
                    ...
                    <div class="card-body pt-7">
                        <div class="text-center">
                            <h5 class="h3">{{ auth()->user()->student->name }} | {{ auth()->user()->student->age }}
                            ...
                            <div class="h5 mt-4">
                                ...
                                {{ auth()->user()->student->grade }}
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>
                                {{ auth()->user()->student->school }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card bg-gradient-success border-0">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0 text-white">Total kelas
                                        </h5>
                                        <span
                                            class="h2 font-weight-bold mb-0 text-white">{{ auth()->user()->student->classrooms_count }}</span>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h2 font-weight-bold mb-0 text-white">{{ auth()->user()->student->attendances_count }}</span>
                                    </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-white text-dark rounded-circle shadow">
                    ...
                    <div class="card-body">
                        ...
                        @if($errors->updateProfileInformation->any())
                            ...
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                ...
                                <span class="alert-text"><strong>Eror!</strong>
                                    {{ $error }}</span>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control"
                                            placeholder="Username" value="{{ auth()->user()->student->name }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="address" name="address" class="form-control"
                                            value="{{ auth()->user()->student->address }}" type="text">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="grade" name="grade">
                                            @foreach ($grades as $grade)
                                                @if ($grade == auth()->user()->student->grade)
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="school">Asal Sekolah</label>
                                        <input type="text" id="school" name="school" class="form-control"
                                            value="{{ auth()->user()->student->school }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="birthplace" name="birthplace" class="form-control"
                                            value="{{ auth()->user()->student->birthplace }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="birthdate">Tanggal Lahir</label>
                                        <input type="datepicker" id="birthdate" name="birthdate" class="form-control datepicker" data-date-format="yyyy-mm-dd" value="{{ auth()->user()->student->birthdate }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="parent_name">Nama Orang Tua</label>
                                        <input type="text" id="parent_name" name="parent_name" class="form-control"
                                            value="{{ auth()->user()->student->parent_name }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="parent_job">Pekerjaan Orang Tua</label>
                                        <input type="text" id="parent_job" name="parent_job" class="form-control"
                                            value="{{ auth()->user()->student->parent_job }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="parent_phone">No Telepon Orang Tua</label>
